...
if len(password) < 6:
    print('Too Short')
elif password =='123456' or 'password':
    print('Too Simple')
else:
    print('Validating...')
...
# Write logic here:
if password =='Admin' and PIN == 9999:
...
# Write logic here:
pwd_length = 10 <= len(master_pwd) <= 20
Word_login = 'login' not in master_pwd.lower()
start_with = master_pwd.startswith('!') or master_pwd.startswith('@')
if pwd_length and Word_login and start_with :
...
>>>>>>> d9d038dba9b9fe335ad67e03157e75d3596e85d6
